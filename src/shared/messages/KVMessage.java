...
public interface KVMessage {
    ...
    public enum StatusType {
        ...
        SQLCREATE_REPLICATE,
        SQLCREATE_REPLICATE_SUCCESS,
        SQLCREATE_REPLICATE_ERROR,
        
        SQLSELECT_REPLICATE,
        SQLSELECT_REPLICATE_SUCCESS,
        SQLSELECT_REPLICATE_ERROR,

        SQLDROP_REPLICATE,
        SQLDROP_REPLICATE_SUCCESS,
        SQLDROP_REPLICATE_ERROR,

        SQLINSERT_REPLICATE,
        SQLINSERT_REPLICATE_SUCCESS,
        SQLINSERT_REPLICATE_ERROR,
        
        SQLUPDATE_REPLICATE,
        SQLUPDATE_REPLICATE_SUCCESS,
        SQLUPDATE_REPLICATE_ERROR,
    }
